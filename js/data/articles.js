window.ARTICLES = [
    {
        ...
        authors: [
            { name: "Mehmet Kaya", affiliation: "Department of Cardiology, Istanbul University-Cerrahpasa, Istanbul, Turkey", orcid: "0000-0002-4781-3209" },
            { name: "Ayse Demir", affiliation: "Department of Cardiology, Istanbul University-Cerrahpasa, Istanbul, Turkey", orcid: "0000-0003-5512-7843" },
    ...
    },
    {
        ...
        authors: [
            { name: "Elif Yilmaz", affiliation: "Department of Medical Oncology, Hacettepe University Faculty of Medicine, Ankara, Turkey", orcid: "0000-0002-8834-1927" },
            { name: "Cem Ozturk", affiliation: "Department of Medical Oncology, Hacettepe University Faculty of Medicine, Ankara, Turkey", orcid: "0000-0003-2290-4561" },
    ...
    },
    {
        ...
        authors: [
            { name: "Burak Celik", affiliation: "Department of Gastroenterology, Trakya University Faculty of Medicine, Edirne, Turkey", orcid: "0000-0002-5678-2341" },
    ...
    },
    {
        ...
        authors: [
            { name: "Hasan Balci", affiliation: "Department of Internal Medicine, Trakya University Faculty of Medicine, Edirne, Turkey", orcid: "0000-0002-3345-6712" },
    ...
    },
    {
        ...
        authors: [
            { name: "Selin Aktas", affiliation: "Department of Neurology, Ankara University Faculty of Medicine, Ankara, Turkey", orcid: "0000-0003-6712-2089" },
            { name: "Oguz Tanridag", affiliation: "Department of Neurology, Trakya University Faculty of Medicine, Edirne, Turkey", orcid: "0000-0002-7845-1302" }
        ],
    ...
    },
    {
        ...
        authors: [
            { name: "Fatma Sahin", affiliation: "Department of Endocrinology and Metabolism, Dokuz Eylul University Faculty of Medicine, Izmir, Turkey", orcid: "0000-0001-2398-7654" },
    ...
    },
    {
        ...
        authors: [
            { name: "Murat Acar", affiliation: "Department of Clinical Microbiology, Istanbul University Faculty of Medicine, Istanbul, Turkey", orcid: "0000-0002-1890-4327" },
    ...
    },
    {
        ...
        authors: [
            { name: "Ates Kara", affiliation: "Editor-in-Chief, Balkan Medical Journal; Department of Pediatric Infectious Diseases, Hacettepe University Faculty of Medicine, Ankara, Turkey", orcid: "0000-0002-3256-1283" }
        ],
    ...
    },
    {
        ...
        authors: [
            { name: "Zeynep Erdogan", affiliation: "Department of Cardiology, Gazi University Faculty of Medicine, Ankara, Turkey", orcid: "0000-0001-4567-8910" },
    ...
    },
    {
        ...
        authors: [
            { name: "Ali Toprak", affiliation: "Department of Pulmonology, Ege University Faculty of Medicine, Izmir, Turkey", orcid: "0000-0002-7890-1234" },
            { name: "Emre Sivri", affiliation: "Department of Pulmonology, Ege University Faculty of Medicine, Izmir, Turkey", orcid: "0000-0001-3456-7890" },
    ...
    },
    {
        ...
        authors: [
            { name: "Deniz Ozen", affiliation: "Department of Rheumatology, Ankara University Faculty of Medicine, Ankara, Turkey", orcid: "0000-0001-5678-9012" },
    ...
    },
    {
        ...
        authors: [
            { name: "Ozge Basaran", affiliation: "Department of Pediatric Rheumatology, Hacettepe University Faculty of Medicine, Ankara, Turkey", orcid: "0000-0003-8765-4321" },
            { name: "Nuray Aktay Ayaz", affiliation: "Department of Pediatric Rheumatology, Istanbul University Faculty of Medicine, Istanbul, Turkey", orcid: "0000-0002-9876-5432" },
    ...
    },
    {
        ...
        authors: [
            { name: "Baris Metin", affiliation: "Department of Neurology, Erciyes University Faculty of Medicine, Kayseri, Turkey", orcid: "0000-0002-1357-9024" },
    ...
    },
    {
        ...
        authors: [
            { name: "Serkan Ocal", affiliation: "Department of Internal Medicine, Division of Intensive Care, Hacettepe University Faculty of Medicine, Ankara, Turkey", orcid: "0000-0003-9012-3456" },
            ...
            { name: "Arda Guclu", affiliation: "Department of Biomedical Engineering, Middle East Technical University, Ankara, Turkey", orcid: "0000-0003-7890-4567" }
        ],
    ...
    },
    {
        ...
        authors: [
            { name: "Kerem Erkalp", affiliation: "Department of Medical Oncology, Istanbul University Institute of Oncology, Istanbul, Turkey", orcid: "0000-0002-4321-8765" },
            ...
            { name: "Canan Ersoy", affiliation: "Department of Cardiology, Istanbul University Institute of Oncology, Istanbul, Turkey", orcid: "0000-0003-5432-1098" }
        ],
    ...
    },
    {
        id: 2428,
        type: "Brief Report",
        title: "Seroprevalence of Hepatitis E Virus Antibodies Among Pregnant Women in Southeastern Turkey: A Cross-Sectional Study",
        authors: [
            { name: "Gulden Sonmez", affiliation: "Department of Infectious Diseases and Clinical Microbiology, Dicle University Faculty of Medicine, Diyarbakir, Turkey", orcid: "0000-0001-2340-5678" },
            { name: "Ahmet Uludag", affiliation: "Department of Obstetrics and Gynecology, Dicle University Faculty of Medicine, Diyarbakir, Turkey", orcid: "0000-0002-6789-0123" }
        ],
        abstract: "Background: Hepatitis E virus infection during pregnancy can lead to fulminant hepatic failure with high maternal mortality, particularly in developing regions. Seroprevalence data from southeastern Turkey remain limited. Aims: To determine the seroprevalence of hepatitis E virus antibodies among pregnant women in Diyarbakir, southeastern Turkey. Methods: Serum samples from 468 pregnant women attending antenatal clinics at Dicle University Hospital between January and August 2024 were tested for anti-hepatitis E virus immunoglobulin G and immunoglobulin M using enzyme-linked immunosorbent assays. Demographic and clinical data were collected via structured questionnaires. Results: Anti-hepatitis E virus immunoglobulin G was detected in 34 women (7.3%; 95% confidence interval 5.2-10.0). Anti-hepatitis E virus immunoglobulin M, indicating recent or active infection, was positive in 3 women (0.6%). Seroprevalence was significantly higher among women living in rural areas (11.2% vs. 5.4%; p=0.03) and those using untreated water sources (14.8% vs. 5.9%; p=0.008). No significant associations were found with age, parity, or trimester. All three immunoglobulin M-positive women had mildly elevated transaminases but no clinical hepatitis. Conclusion: Hepatitis E virus seroprevalence among pregnant women in southeastern Turkey is notable and associated with rural residence and untreated water use, underscoring the need for improved water sanitation and potential screening strategies in this vulnerable population.",
        keywords: ["hepatitis E virus", "seroprevalence", "pregnancy", "southeastern Turkey"],
    ...
    },
    {
        ...
        authors: [
            { name: "Tolga Sinan Guvenc", affiliation: "Department of Cardiology, Trakya University Faculty of Medicine, Edirne, Turkey", orcid: "0000-0001-7890-2345" },
            { name: "Gorkem Mungan", affiliation: "Department of Cardiovascular Surgery, Trakya University Faculty of Medicine, Edirne, Turkey", orcid: "0000-0002-0123-4567" },
